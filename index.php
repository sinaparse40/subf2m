...
$base 		= 'http://api.xoli.ir/'; // آدرس هر ماه چک کنید،اگر سایت قطع بود،سریع ادرس جدید را از تلگرام ما پیام دهید و آدرس جدید را دریافت کنید @i_adminastator
...
if (curl_error($curlSession)){
	...
	$body = preg_replace('#tablighat-header#is', 'code java va tablighat', $body); //کد تبلیغات خود را اینجا جایگزین نمایید
	$body = preg_replace('#mywebsiteaddres#is', 'addres-website-shoma.ir', $body); // اینجا آدرس وبسایت خود را وارد نمایید
